...
"""
create_tesnor_of_val() : makes a tensor of given dimension and fills it with the given value.
calculate_elemenetwise_product() : checks if two tensors have the same size and gives elementwise product.
calculate_matrix_product() : calculates matrix product.
calculate_matrix_prod_with_bias() : calculates matrix product with bias.
...
def calculate_activation(sum_total):
    ...
    res = torch.heaviside(sum_total,values)
    return res
